...
app.use("/api/project", require("./routers/project")); //项目
app.use("/api/daily", require("./routers/daily")); //日报
...
mongoose.connect(
    ...
    (err) => {
        if (err) {
            ...
            app.listen(8080, () => {
                console.log("******", "serve is running at port 8888...");
            });
        }
    }
);
